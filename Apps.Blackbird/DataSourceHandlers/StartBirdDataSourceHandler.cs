...
public class StartBirdDataSourceHandler : BlackbirdAppInvocable, IAsyncDataSourceHandler
{
    private readonly StartBirdRequest _birdRequest;

    public StartBirdDataSourceHandler(InvocationContext invocationContext, [ActionParameter] StartBirdRequest birdRequest) : base(
        invocationContext)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint = $"nests/{_birdRequest.NestId}/birds?triggerType=manual";
